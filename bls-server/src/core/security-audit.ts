...
export const SecurityEventType = {
  ...
  CAPTCHA_VISIBLE_REQUIRED:   'CAPTCHA_VISIBLE_REQUIRED',
  CAPTCHA_VISIBLE_PASSED:     'CAPTCHA_VISIBLE_PASSED',
...
const EVENT_RISK: Record<string, RiskLevel> = {
  ...
  CAPTCHA_VISIBLE_REQUIRED:   RiskLevel.MEDIUM,
  CAPTCHA_VISIBLE_PASSED:     RiskLevel.LOW,
  CAPTCHA_VISIBLE_FAILED:     RiskLevel.MEDIUM,
